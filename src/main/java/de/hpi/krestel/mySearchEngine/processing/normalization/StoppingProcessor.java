...
public class StoppingProcessor extends AbstractEachElementProcessor {

	Set<String> stopwords = new HashSet<String>();
	public StoppingProcessor() {
		stopwords.addAll(
				Arrays.asList("aber", "alle", "allem", "allen", "aller", "alles", "als", "also", "am", "an",
				"ander", "andere", "anderem", "anderen", "anderer", "anderes", "anderm", "andern", "anderr", "anders",
				"auch", "auf", "aus", "bei", "bin", "bis", "bist", "da", "damit", "dann",
				"der", "den", "des", "dem", "die", "das", "daß", "dass", "derselbe", "derselben",
				...
				"unse", "unsem", "unsen", "unser", "unses", "unter", "viel", "vom", "von", "vor",
